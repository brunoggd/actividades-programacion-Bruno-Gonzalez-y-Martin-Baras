...
class SistemaBaseDeDatos(QMainWindow):
    ...
    def crear_interfaz(self):
        ...
        self.boton_crear_base_de_datos=QPushButton("CREAR BASE DE DATOS")
        self.boton_crear_base_de_datos.clicked.connect(self.crear_base_de_datos)
        ...
        self.layout_botones.addWidget(self.boton_crear_base_de_datos,alignment=Qt.AlignCenter)
    ...
    def crear_base_de_datos(self):
        self.boton_crear_base_de_datos.hide()
        conexion=self.conectar_mysql()
        try:
            cursor=conexion.cursor()
            cursor.execute("CREATE DATABASE IF NOT EXISTS EjemploBD;")
            QMessageBox.information(self,"Exito","Base de datos creada con éxito.")
            self.crear_tabla_usuarios()
        except Error as e:
            QMessageBox.warning(self,"Error",f"Error al crear la base de datos: {e}")
